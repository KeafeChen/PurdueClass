...
class ScheduleVC: UIViewController, FSCalendarDelegate, FSCalendarDataSource, UITableViewDelegate, UITableViewDataSource {
    ...
    @IBAction func export(_ sender: Any) {
        ...
        // DO NOT DELETE
        /* for add to google calendar
 
        let jsonToken = CkoJsonObject()
        var success: Bool = jsonToken.LoadFile("qa_data/tokens/googleCalendar.json")
        ...
        json.UpdateString("summary", value: "Eat Lou Malnati's Pizza")
        json.UpdateString("start.dateTime", value: "2017-08-12T12:00:00-05:00")
        json.UpdateString("end.dateTime", value: "2017-08-12T13:00:00-05:00")
        ...
        */
        ...
        //  }
        /*
        var url: String? = "https://www.googleapis.com/calendar/v3/calendars/{$calendarId}/events"
        http.SetUrlVar("calendarId", value: "primary")
        var response: CkoHttpResponse? = http.PostJson3(url, contentType: "application/json", json: json)
        ...
        jsonResp.Load(response!.BodyStr)
